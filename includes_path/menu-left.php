<ul id="slide-out-left" class="side-nav collapsible" data-collapsible="accordion">
        ...
        <?php } ?>
        <li><a href="<?php echo htmlspecialchars("?page=calendario");?>"><i class="fa fa-calendar"></i>Calendários</a></li>
        ...
        <li><a href="<?php echo htmlspecialchars("?page=contato");?>"><i class="fa fa-envelope"></i>Ajuda</a></li>    
    </ul>